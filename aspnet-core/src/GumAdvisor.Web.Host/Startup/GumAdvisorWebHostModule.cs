...
using GumAdvisor.Authorization.Users.Password;
using GumAdvisor.Configuration;
using GumAdvisor.EntityFrameworkCore;
using GumAdvisor.MultiTenancy;
using GumAdvisor.Web.Startup.ExternalLoginInfoProviders;
...
namespace GumAdvisor.Web.Startup
{
    ...
    public class GumAdvisorWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public GumAdvisorWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(GumAdvisorWebHostModule).GetAssembly());
        }

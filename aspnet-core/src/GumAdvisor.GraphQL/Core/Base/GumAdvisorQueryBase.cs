...
namespace GumAdvisor.Core.Base
{
    public abstract class GumAdvisorQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected GumAdvisorQueryBase(string fieldName,

...
using GumAdvisor.Core.Base;
using GumAdvisor.Core.Extensions;
using GumAdvisor.Dto;
using GumAdvisor.Types;

namespace GumAdvisor.Queries
{
    public class OrganizationUnitQuery : GumAdvisorQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {

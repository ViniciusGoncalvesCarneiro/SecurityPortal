...
namespace GumAdvisor.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : GumAdvisorServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("GumAdvisor", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);

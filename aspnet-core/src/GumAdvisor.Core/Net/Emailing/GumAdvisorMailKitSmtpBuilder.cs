...
{
    public class GumAdvisorMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public GumAdvisorMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(GumAdvisorConsts.LocalizationSourceName, name);
        }
    }
}
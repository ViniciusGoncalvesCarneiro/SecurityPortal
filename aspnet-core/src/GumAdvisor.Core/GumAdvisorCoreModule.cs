...
using GumAdvisor.Authorization.Ldap;
...
using GumAdvisor.DashboardCustomization.Definitions;
using GumAdvisor.Debugging;
using GumAdvisor.DynamicEntityProperties;
using GumAdvisor.Features;
using GumAdvisor.Friendships;
using GumAdvisor.Friendships.Cache;
using GumAdvisor.Localization;
using GumAdvisor.MultiTenancy;
using GumAdvisor.Net.Emailing;
using GumAdvisor.Notifications;
using GumAdvisor.WebHooks;
using Newtonsoft.Json;

namespace GumAdvisor
{
    [DependsOn(
        typeof(GumAdvisorCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class GumAdvisorCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            GumAdvisorLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = GumAdvisorConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, GumAdvisorMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<GumAdvisorSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(GumAdvisorCoreModule).GetAssembly());
        }

...
{
    public class StripeGatewayManager : GumAdvisorServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "GumAdvisor";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + GumAdvisorConsts.Currency;
        }

...
namespace GumAdvisor.Web.Public.Startup
{
    [DependsOn(
        typeof(GumAdvisorWebCoreModule)
    )]
    public class GumAdvisorWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public GumAdvisorWebFrontEndModule(IWebHostEnvironment env, GumAdvisorEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(GumAdvisorWebFrontEndModule).GetAssembly());
        }
    }
}

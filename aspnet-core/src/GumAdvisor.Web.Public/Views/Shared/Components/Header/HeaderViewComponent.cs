...
using GumAdvisor.Web.Public.Startup;
using GumAdvisor.Web.Session;

namespace GumAdvisor.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : GumAdvisorViewComponent
    {

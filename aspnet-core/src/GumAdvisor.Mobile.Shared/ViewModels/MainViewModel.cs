...
using GumAdvisor.Commands;
using GumAdvisor.Core.Threading;
using GumAdvisor.Models.NavigationMenu;
using GumAdvisor.Services.Navigation;
...
using GumAdvisor.ApiClient;
using GumAdvisor.Controls;
using GumAdvisor.Dto;
using GumAdvisor.Extensions;
using GumAdvisor.Localization;
using GumAdvisor.UI;
using GumAdvisor.UI.Assets;
using GumAdvisor.Views;
using DependencyResolver = GumAdvisor.Core.Dependency.DependencyResolver;
...
namespace GumAdvisor.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "GumAdvisor";

...
{
    public class SessionAppService : GumAdvisorAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = GumAdvisorConsts.Currency,
                        CurrencySign = GumAdvisorConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = GumAdvisorConsts.AllowTenantsToChangeEmailSettings,

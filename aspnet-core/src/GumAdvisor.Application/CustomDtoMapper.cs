...
using GumAdvisor.Authorization.Roles.Dto;
using GumAdvisor.Authorization.Users;
using GumAdvisor.Authorization.Users.Delegation.Dto;
using GumAdvisor.Authorization.Users.Dto;
using GumAdvisor.Authorization.Users.Importing.Dto;
using GumAdvisor.Authorization.Users.Profile.Dto;
...
using GumAdvisor.Friendships.Dto;
using GumAdvisor.Localization.Dto;
...
namespace GumAdvisor
{
    internal static class CustomDtoMapper
    {
        public static void CreateMappings(IMapperConfigurationExpression configuration)
        {
            ...
            configuration.CreateMap<NistDto, Nist>().ReverseMap();
            configuration.CreateMap<CisToIsoDto, CisToIso>().ReverseMap();
            configuration.CreateMap<CisToMitreDto, CisToMitre>().ReverseMap();
            configuration.CreateMap<CisToNistDto, CisToNist>().ReverseMap();
            // Pesquisa

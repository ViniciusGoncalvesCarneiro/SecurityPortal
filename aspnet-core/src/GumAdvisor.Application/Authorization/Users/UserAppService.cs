...
using GumAdvisor.Authorization.Permissions;
...
using GumAdvisor.Authorization.Users.Exporting;
...
namespace GumAdvisor.Authorization.Users
{
    ...
    public class UserAppService : GumAdvisorAppServiceBase, IUserAppService
    {

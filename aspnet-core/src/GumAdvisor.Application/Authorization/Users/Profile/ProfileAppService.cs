...
using GumAdvisor.Authorization.Users.Profile.Cache;
using GumAdvisor.Authorization.Users.Profile.Dto;
using GumAdvisor.Configuration;
using GumAdvisor.Friendships;
using GumAdvisor.Gdpr;
using GumAdvisor.Net.Sms;
using GumAdvisor.Security;
using GumAdvisor.Storage;
using GumAdvisor.Timing;
using SixLabors.ImageSharp;
using SixLabors.ImageSharp.Formats;
using SixLabors.ImageSharp.Processing;

namespace GumAdvisor.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : GumAdvisorAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("GumAdvisor",

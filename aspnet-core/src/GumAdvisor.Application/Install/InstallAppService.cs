...
using GumAdvisor.Migrations.Seed.Host;
...
namespace GumAdvisor.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : GumAdvisorAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<GumAdvisorDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{GumAdvisorConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{GumAdvisorConsts.ConnectionStringName}", constring);
        }

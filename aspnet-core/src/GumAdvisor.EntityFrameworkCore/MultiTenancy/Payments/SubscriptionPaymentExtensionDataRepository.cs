...
using GumAdvisor.EntityFrameworkCore.Repositories;

namespace GumAdvisor.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : GumAdvisorRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<GumAdvisorDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }

...
{
    public class UserRepository : GumAdvisorRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<GumAdvisorDbContext> dbContextProvider)

...
using GumAdvisor.Authentication.TwoFactor;
using GumAdvisor.Chat;
using GumAdvisor.Configuration;
using GumAdvisor.EntityFrameworkCore;
using GumAdvisor.Startup;
using GumAdvisor.Web.Authentication.JwtBearer;
using GumAdvisor.Web.Authentication.TwoFactor;
using GumAdvisor.Web.Chat.SignalR;
using GumAdvisor.Web.Common;
using GumAdvisor.Web.Configuration;
using GumAdvisor.Web.DashboardCustomization;

namespace GumAdvisor.Web
{
    [DependsOn(
        typeof(GumAdvisorApplicationModule),
        typeof(GumAdvisorEntityFrameworkCoreModule),
    ...
    public class GumAdvisorWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public GumAdvisorWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(GumAdvisorApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(GumAdvisorWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(GumAdvisorWebCoreModule).Assembly);
        }

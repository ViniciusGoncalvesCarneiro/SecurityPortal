...
/// </summary>
public static class GumAdvisorJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, GumAdvisorAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}

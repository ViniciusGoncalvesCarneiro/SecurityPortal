...
{
    public class GumAdvisorAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public GumAdvisorAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,

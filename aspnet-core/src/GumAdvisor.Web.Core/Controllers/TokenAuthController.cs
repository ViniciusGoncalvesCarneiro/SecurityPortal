...
using GumAdvisor.Authentication.TwoFactor.Google;
...
namespace GumAdvisor.Web.Controllers
{
    ...
    public class TokenAuthController : GumAdvisorControllerBase
    {

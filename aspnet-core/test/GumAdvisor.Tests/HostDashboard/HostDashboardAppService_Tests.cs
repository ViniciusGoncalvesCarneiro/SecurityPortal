...
using GumAdvisor.MultiTenancy.HostDashboard;
...
namespace GumAdvisor.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(GumAdvisorDbContext context, SubscriptionPayment subscriptionPayment)
        {
